        ...
        <>
          ...
          <nav className="cyber-header-dock">
            ...
            <div className="hidden lg:flex flex-row gap-16">
              <NavOption label="SİSTEM_ÇEKİRDEK" icon={Activity} active={activeSection === 0} onClick={() => scrollToSection(0)} />
          ...
          <main ref={containerRef} onScroll={handleScroll} className="snap-container no-scrollbar pb-10">
            ...
            <section className="snap-section flex flex-col items-center justify-center pt-20">
               <div className="section-content w-full h-full max-w-[1800px]">
                  <motion.div 
            ...
            <section className="snap-section flex flex-col items-center justify-center">
               <div className="section-content flex flex-col justify-center gap-6 w-full max-w-[1800px]">
            ...
            {/* ═══════════════ BÖLÜM 2: VERİ ARŞİVİ ═══════════════ */}
            <section className="snap-section flex flex-col h-full pt-28 pb-10">
               <div className="section-content flex flex-col h-full max-w-[1800px]">
